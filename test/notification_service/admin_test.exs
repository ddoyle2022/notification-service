defmodule NotificationService.AdminTest do
  use NotificationService.DataCase

  alias NotificationService.Admin

  describe "users" do
    alias NotificationService.Admin.User

    import NotificationService.AdminFixtures
